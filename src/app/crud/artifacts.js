BaseArtifactsController.$inject = ['$ctrl', '$scope', 'artifactsMetadata', '$breadcrumb', '$vamp', 'uiStatesFactory', '$state', '$stateParams',
  '$filter', 'filterFilter', 'toastr', 'alert'];

function BaseArtifactsController($ctrl, $scope, artifactsMetadata, $breadcrumb, $vamp, uiStatesFactory,
